...
public class Constanten {
    ...
    public static int DISPATCHER_PORT = 6666;

    public static final int AANTAL_DATABANKEN = 3;
    public static final String DATABANK_IP = "localhost";
    public static final int DATABANK_POORTRANGE_START = 6690;
